    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('birthday', models.DateField(blank=True, help_text='Введите вашу дату рождения', null=True, verbose_name='Дата рождения')),
                ...
                ('reward_points', models.PositiveIntegerField(default=0, verbose_name='Баллы')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value', models.PositiveIntegerField(default=1, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(100)], verbose_name='Ценность')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Введите профессиоанльный навык/хардскилл', max_length=255, unique=True, verbose_name='Хардскилл')),
            ],
            options={
