# Generated by Django 3.2.19 on 2023-08-21 08:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(db_index=True, help_text='Введите имя пользователя', max_length=255, unique=True, verbose_name='Ник-нейм')),
        ...
        migrations.AddField(
            model_name='user',
            name='groups',
            field=models.ManyToManyField(blank=True, related_name='users_groups', through='users.Membership', to='users.Group', verbose_name='Группа'),
        ),
        migrations.AddField(
            model_name='user',
