...
router.register(r'progress/users', ProgressUserAndDepartmentViewSet, basename='achievements-users')
...
urlpatterns = [
    ...
    path('user/my_notifications/', UserNotificationsViewSet.as_view({'get': 'list'}), name='user-notifications'),
